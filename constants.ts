import { Faction, FactionId, Province, Technology, TechCategory, RoguelikeTrait, Building, Decree, Unit, UnitType, TerrainType, TutorialStep, Region, DiplomaticRelation } from './types';
...
export const TUTORIAL_STEPS: TutorialStep[] = [
  {
    id: 'welcome',
    title: '¡Bienvenido a Imperium Aeterna!',
    description: 'Guiarás a tu imperio hacia la gloria a través de la conquista, el comercio y la diplomacia. Aprende los controles básicos en este tutorial.',
    position: 'center'
  },
  {
    id: 'map_navigation',
    title: '🗺️ Navegación del Mapa',
    description: 'Arrastra el mapa para moverte por el mundo. Usa la rueda del ratón para hacer zoom. Los botones de la izquierda cambian entre vistas Política, Terreno y Económica.',
    position: 'right'
  },
  {
    id: 'resources',
    title: '💰 Recursos del Imperio',
    description: 'En la barra superior ves tu Oro (☧) y Mano de Obra (👥). El oro se usa para construir y reclutar. La mano de obra alimenta tus ejércitos.',
    position: 'bottom'
  },
  {
    id: 'select_province',
    title: '🏛️ Selecciona una Provincia',
    description: 'Haz clic en una de TUS provincias (con tu color) para ver sus detalles. Podrás construir edificios, reclutar tropas y ver información económica.',
    action: 'SELECT_OWN_PROVINCE',
    position: 'left'
  },
  {
    id: 'province_tabs',
    title: '📋 Panel de Provincia',
    description: 'El panel tiene 3 pestañas: OVERVIEW (resumen), ECONOMY (construcción) y MILITARY (tropas). Explora cada una para gestionar tu provincia.',
    position: 'left'
  },
  {
    id: 'recruit_troops',
    title: '⚔️ Reclutar Tropas',
    description: 'Ve a la pestaña MILITARY y recluta una unidad. Necesitas oro y mano de obra suficiente. ¡Las tropas son esenciales para conquistar!',
    action: 'RECRUIT_UNIT',
    position: 'left'
  },
  {
    id: 'reinforcements',
    title: '🎲 Sistema de Refuerzos',
    description: 'Al inicio de cada turno recibes tropas gratis basadas en tus provincias. ¡Conquistar regiones completas da bonus extra!',
    position: 'center'
  },
  {
    id: 'attack_enemy',
    title: '⚔️ Atacar Enemigos',
    description: 'Selecciona un territorio enemigo ADYACENTE a tus tropas. Si tienes ejército en una provincia vecina, podrás declarar la guerra.',
    action: 'DECLARE_WAR',
    position: 'center'
  },
  {
    ...
    description: 'Cuando termines tus acciones, pulsa el botón naranja (➤) para avanzar al siguiente turno. El tiempo pasa y tus enemigos también actúan.',
    action: 'END_TURN',
    position: 'top'
  },
  {
    ...
    description: '¡Ya conoces lo básico! Explora el árbol tecnológico (⚡), negocia con otras facciones, y conquista el mundo conocido. ¡Gloria a tu imperio!',
    position: 'center'
  }
];

// --- GEOGRAPHIC REGIONS (Risk-style bonuses) ---
export const REGIONS: Region[] = [
  {
    id: 'italia',
    name: 'Italia',
    provinceIds: ['p_cisalpina', 'p_etruria', 'p_roma', 'p_samnium', 'p_campania', 'p_apulia', 'p_calabria'],
    bonusTroops: 5,
    color: '#b91c1c'
  },
  {
    id: 'hispania',
    name: 'Hispania',
    provinceIds: ['p_tarraconensis', 'p_lusitania', 'p_carthaginensis', 'p_baetica'],
    bonusTroops: 3,
    color: '#c2410c'
  },
  {
    id: 'gallia',
    name: 'Gallia',
    provinceIds: ['p_lugdunensis', 'p_belgica', 'p_gallia_comata', 'p_aquitania', 'p_transalpina', 'p_narbonensis'],
    bonusTroops: 4,
    color: '#15803d'
  },
  {
    id: 'britannia',
    name: 'Britannia',
    provinceIds: ['p_caledonia', 'p_britannia_n', 'p_britannia_s', 'p_hibernia'],
    bonusTroops: 2,
    color: '#0f766e'
  },
  {
    id: 'germania',
    name: 'Germania',
    provinceIds: ['p_germania_inf', 'p_germania_magna', 'p_germania_sup'],
    bonusTroops: 3,
    color: '#3f3f46'
  },
  {
    id: 'graecia',
    name: 'Graecia',
    provinceIds: ['p_macedonia', 'p_thessaly', 'p_epirus', 'p_attica', 'p_peloponnese'],
    bonusTroops: 4,
    color: '#1e3a8a'
  },
  {
    id: 'africa',
    name: 'Africa',
    provinceIds: ['p_tingitana', 'p_mauretania_caes', 'p_numidia', 'p_carthage', 'p_tripolitania', 'p_cyrenaica'],
    bonusTroops: 4,
    color: '#eab308'
  },
  {
    id: 'aegyptus',
    name: 'Aegyptus',
    provinceIds: ['p_aegyptus', 'p_thebais', 'p_cyrenaica'],
    bonusTroops: 3,
    color: '#d97706'
  },
  {
    id: 'asia_minor',
    name: 'Asia Minor',
    provinceIds: ['p_asia', 'p_bithynia', 'p_lycia', 'p_galatia', 'p_pontus', 'p_cappadocia', 'p_cilicia'],
    bonusTroops: 5,
    color: '#7e22ce'
  },
  {
    id: 'oriens',
    name: 'Oriens',
    provinceIds: ['p_syria', 'p_palestina', 'p_arabia_petraea', 'p_mesopotamia', 'p_armenia'],
    bonusTroops: 5,
    color: '#dc2626'
  },
  {
    id: 'persia',
    name: 'Persia',
    provinceIds: ['p_media', 'p_susiana', 'p_persis', 'p_babylonia', 'p_parthia_prop'],
    bonusTroops: 4,
    color: '#6b21a8'
  }
];
...
// --- INITIAL DIPLOMACY ---
export const createInitialDiplomacy = (): Record<FactionId, Record<FactionId, DiplomaticRelation>> => {
  const relations: Record<FactionId, Record<FactionId, DiplomaticRelation>> = {} as any;
  const allFactions = Object.values(FactionId);

  allFactions.forEach(f1 => {
    relations[f1] = {} as Record<FactionId, DiplomaticRelation>;
    allFactions.forEach(f2 => {
      if (f1 === f2) relations[f1][f2] = 'NEUTRAL';
      else if (f1 === FactionId.NEUTRAL || f2 === FactionId.NEUTRAL) relations[f1][f2] = 'NEUTRAL';
      else if (f1 === FactionId.REBELS || f2 === FactionId.REBELS) relations[f1][f2] = 'WAR';
      else relations[f1][f2] = 'NEUTRAL';
    });
  });

  // Historical rivalries
  relations[FactionId.ROME][FactionId.CARTHAGE] = 'HOSTILE';
  relations[FactionId.CARTHAGE][FactionId.ROME] = 'HOSTILE';
  relations[FactionId.ROME][FactionId.GAUL] = 'HOSTILE';
  relations[FactionId.GAUL][FactionId.ROME] = 'HOSTILE';
  relations[FactionId.MACEDON][FactionId.ROME] = 'HOSTILE';
  relations[FactionId.ROME][FactionId.MACEDON] = 'HOSTILE';
